...
grep -v "shorttitle = {" ../Biblio/library.bib | grep -v "mendeley-tags = {" | grep -v "institution = {" | grep -v "publisher = {" | grep -v "pages = {" | grep -v "month = " | grep -v "doi = {" | grep -v "pmid = {" | grep -v "url = {" | grep -v "file = {" | grep -v "abstract = {" | grep -v "keywords = {" | grep -v "isbn = {" | grep -v "issn = {" | grep -v "editor = {" | grep -v "address = {" | grep -v "annote = {" > Bibliography/biblio.bib
