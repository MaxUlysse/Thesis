...
\mainmatter
	...
	\begin{appendices}					% Appendices
		...
		\input{tex/07a-nomenclature}	% Nomenclature used
		\input{tex/07b-acronyms}		% Acronyms used
		\input{tex/07c-publications}	% All your publications
	\end{appendices}
...
\backmatter
	...
	% \phantomsection			
	% \printindex				NOT WORKING YET, NEED TO CORRECT THAT
	% \clearemptydoublepage		
