\mychapter{white!15!black}{Abréviations}
	\section{\textcolor{white!15!black}{Gènes}}\label{app:ac:gènes}
		\begin{acronym}[CDKN2A]
			...
			\acro	{CDK2}		[\emph{CDK2}]	{cyclin-dependent kinase 2}
			\acro	{CDKN1A}	[\emph{CDKN1A}]	{cyclin-dependent kinase inhibitor 1A (p21, Cip1)}
			...
			\acro	{IGFR}		[\emph{IGFR}]	{insulin-like growth factor 1 receptor}
			...
			\acro	{NCK1}		[\emph{NCK1}]	{NCK adaptor protein 1}
			\acro	{NF1}		[\emph{NF1}]	{neurofibromin 1}
			\acro	{NPAS2}		[\emph{NPAS2}]	{neuronal PAS domain protein 2}
			\acro	{NQO1}		[\emph{NQO1}]	{NAD(P)H dehydrogenase, quinone 1}
			\acro	{PDGFB}		[\emph{PDGFB}]	{platelet-derived growth factor beta polypeptide}
			\acro	{PGK1}		[\emph{PGK1}]	{phosphoglycerate kinase 1}
			\acro	{PGR}		[\emph{PGR}]	{progesterone receptor}
			\acro	{PIN1}		[\emph{PIN1}]	{peptidylprolyl cis/trans isomerase, NIMA-interacting 1}
	...
	\section{\textcolor{white!15!black}{Divers}}
		\begin{acronym}[CDKN2A]
			...
			\acro		{CNV}			[CNV]		{Variation du nombre de copies (\emph{Copy Number Variation})}
			...
			\acro		{GGI}			[GGI]		{Genomic Grade Index}
			...
			\acroplural	{SVM}			[SVMs]		{machines à vecteurs de support (\emph{Support Vector Machines})}
