...
\mychapter{red!45!black}{Introduction générale}
	\sectionred*{Résumé}
		\begin{center}
				\begin{tcolorbox}[colback=red!5!white,colframe=red!45!black,arc=0mm]
					...
					\sffamily
						Ce chapitre introductif présente de façon générale le cancer\index{cancer}.
	...
	\section{\textcolor{red!45!black}{Problématique}}\label{sec:Problématique}
		...
		Deux études de puces à \acs{ADN} ont permis d'établir deux signatures : l'une de 70 gènes (\citet{vantveer2002}) et l'autre de 76 gènes (\citet{Wang2005}) prédisant la rechute métastatique dans le cancer du sein\index{cancer!cancer du sein}.
	...
	\section{\textcolor{red!45!black}{La recherche sur le cancer\index{cancer}}}\label{sec:RechercheCancer}
		...
		\subsection{\textcolor{red!45!black}{Historique}}\label{sub:Historique}
			...
			\begin{table}
				\begin{center}
					\caption{Découvertes et événements majeurs dans le domaine du cancer\index{cancer}.}
					\begin{tabular}{cl}
						\toprule
...
\pagebreak
	...
	\section{\textcolor{red!45!black}{L'apport des technologies à haut-débit à la recherche sur le cancer}}
		...
		\subsection{\textcolor{red!45!black}{L'ère post-génomique et la fin du paradigme \emph{un gène, une maladie}}}
			...
			De nombreuses maladies ont été étudiées par cette approche : Alzheimer : \citet{Ricciarelli2004}, le diabète : \citet{Kaestner2003} ainsi que plusieurs formes de cancer (leucémie : \citet{Golub1999}, cancer du colon : \citet{Li2001}, cancer du sein\index{cancer!cancer du sein} : \citet{Wang2005}) et encore bien d'autres maladies : \citet{Munro2009}.
		...
		\subsection{\textcolor{red!45!black}{Les caractéristiques du cancer du sein\index{cancer!cancer du sein}}}
			...
			\begin{table}
				\begin{center}
					...
					\label{tab:Inca2011}
					\vspace{3ex}
					\caption*{TSM : Taux standardisés à la population mondiale\\Sources : \acf{InVS}, \acf{CépiDc} - \ac{INSERM}, 2011\citep{Inca2011}}
				\end{center}
			\end{table}
...
\pagebreak
		...
		\subsection{\textcolor{red!45!black}{Intérêts des signatures prédictives dans le cancer du sein\index{cancer!cancer du sein}}}
			...
			Ces deux signatures n'ont que trois gènes en commun, ce qui peut mettre en doute leur fiabilité ainsi que leur reproductibilité.
