...
\mychapter{red!60!black}{Introduction générale}
	\sectionred*{Résumé}
		\begin{center}
			\begin{tabular}{c}
				\begin{minipage}[][4cm][c]{0.8\linewidth}
					\begin{tcolorbox}[colback=red!5!white,colframe=red!45!black]
						\sffamily
	...
	\section*{\textcolor{red!60!black}{Problématique}}\label{sec:Problématique}
	...
	\section{\textcolor{red!60!black}{La recherche sur le cancer\index{cancer}}}\label{sec:RechercheCancer}

		\subsection{\textcolor{red!60!black}{Historique}}\label{sub:Historique}
		...
		\subsection{\textcolor{red!60!black}{Rappels sur l'expression des gènes et sa régulation}}\label{sub:RappelsExpression}
...
%			\end{figure}
		...
		\subsection{\textcolor{red!60!black}{Les caractéristiques spécifiques des cancers}}
	...
	\section{\textcolor{red!60!black}{L'apport des technologies à haut-débit à la recherche sur le cancer}}

		\subsection{\textcolor{red!60!black}{L'ère post-génomique et la fin du paradigme \emph{un gène, une maladie}}}
		...
		\subsection{\textcolor{red!60!black}{La médecine prédictive et la médecine personnalisée}}\label{sub:MedPrePer}
	...
	\section{\textcolor{red!60!black}{La recherche sur le cancer du sein\index{cancer!cancer du sein}}}\label{Sec:RechercheBC}

		\subsection{\textcolor{red!60!black}{Les caractéristiques du cancer du sein\index{cancer!cancer du sein}}}
		...
		\subsection{\textcolor{red!60!black}{Diagnostics et traitements}}
		...
		\subsection{\textcolor{red!60!black}{Les classifications utilisées dans le cancer du sein\index{cancer!cancer du sein}}}
		...
		\subsection{\textcolor{red!60!black}{Intérêts des signatures prédictives dans le cancer du sein\index{cancer!cancer du sein}}}
		...
		\subsection{\textcolor{red!60!black}{Les limitations des technologies utilisées}}
		...
		\subsection{\textcolor{red!60!black}{Les solutions}}
	...
	\section{\textcolor{red!60!black}{Conclusion}}
